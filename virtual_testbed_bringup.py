...
#    tftp_dir = "/auto/tftp-sjc-users2/rchaowdh/athena/"+os.path.basename(destn)
    tftp_dir = destn
    #qiangwa comment
  ...
  def create_pyats_yaml(testbed_name, topology_name, subject):
  ...
  def create_tcl_config(testbed_name, topology_name, subject):
    global dd, autoeasy_config
    dd=dr+"/"+testbed_name
...
if __name__ =="__main__":
  ...
  if isPhysical=="False":
    ...
    for testbed in fnl['test']:
      ...
      virtual_harness.create_tcl_config(testbed, topology_name, subject)
      virtual_harness.create_pyats_yaml(testbed, topology_name, subject)
