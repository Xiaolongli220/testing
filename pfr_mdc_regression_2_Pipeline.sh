...
python os_play_pipeline.py -p $private -m $mail -j $job -a $archive -tf $test_framework -ic $input_configuration -pi $pi25 -ui $unique_id -deleteTopology $dt -hb $hb -thb $thb -b1 $b1 -b2 $b2 
