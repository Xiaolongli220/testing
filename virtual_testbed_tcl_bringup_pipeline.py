...
# import make_tcl_job_pipeline as make_tcl_job
import make_tcl_job
import start_dev
import housekeeping
...
#   qiangwa modi
  ...
  def generate_run_job(scr, testbed_name, job_type, topology_name, unique_id):
   ...
   # start_dev.devices_bringup(ylm)'''
    ...
    os.system("autoeasy -mailto %s %s -cf %s -ad /storage/users/dich/report/PI_regression" %(mail_recipient,job_name, job_location))
